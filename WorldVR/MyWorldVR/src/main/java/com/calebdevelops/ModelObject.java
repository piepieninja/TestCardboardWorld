...
public class ModelObject {
    ...
    public ModelObject(MyGLRenderer renderer, float[] vertices, float[] colors, float[] normals, float x, float y, float z, float scaleX, float scaleY, float scaleZ){
        ...
        Matrix.scaleM(mModel,0, scale[0],scale[1],scale[2]);
    ...
    public void rotate(float angle){
        Matrix.rotateM(mModel, 0, angle, 0.5f, 0.5f, 1.0f);
    }
    ...
    public void draw(float[] mView, float[] mViewProjection){
        ...
        GLES20.glUniform1f(mIsFloorParam, floor);
        ...
        GLES20.glDrawArrays(GLES20.GL_TRIANGLES, 0, numVertices/COORDS_PER_VERTEX);
        MyGLRenderer.checkGLError("Drawing cube");
    }
}
